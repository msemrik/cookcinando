...
var UtensilsDialog_React=__webpack_require__(0);var UtensilsDialog_ButtonToolbar=__webpack_require__(10).ButtonToolbar;var Table=__webpack_require__(10).Table;var ToggleButton=__webpack_require__(10).ToggleButton;var UtensilsDialog_Button=__webpack_require__(10).Button;var UtensilsDialog_Modal=__webpack_require__(10).Modal;// var DropdownButton = require('react-bootstrap').DropdownButton;
...
emptyMessage:"You do not have any step. Start by Clicking on Add Step. ",itemActionOnClick:function itemActionOnClick(section){return _this5.updateSelectedSection(section);},itemRightButtons:function itemRightButtons(item){return _this5.getSectionItemRightButtons(item);}// itemRemoveAction: (recipe) => this.removeRecipe(recipe),
// itemRenameAction: (recipe) => this.renameRecipe(recipe),
