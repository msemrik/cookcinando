...
var pages_App = __webpack_require__(72);
...
var RecipePageComponents_NewDialog = __webpack_require__(26);
...
// CONCATENATED MODULE: ./src/enum/MeasurementUnits.js
var measurementUnits=['gr','cc','unit','Cucharada'];/* harmony default export */ var MeasurementUnits = (measurementUnits);
// EXTERNAL MODULE: ./src/components/common/AutoSuggestInput.css
var common_AutoSuggestInput = __webpack_require__(100);

// EXTERNAL MODULE: ./node_modules/react-autosuggest/dist/index.js
var dist = __webpack_require__(67);
var dist_default = /*#__PURE__*/__webpack_require__.n(dist);

// CONCATENATED MODULE: ./src/components/common/AutoSuggestInput.js
var AutoSuggestInput_React=__webpack_require__(0);var AutoSuggestInput_AutoSuggestInput=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(AutoSuggestInput,_React$Component);function AutoSuggestInput(){var _this;Object(classCallCheck["a" /* default */])(this,AutoSuggestInput);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(AutoSuggestInput).call(this));// Autosuggest is a controlled component.
// This means that you need to provide an input value
// and an onChange handler that updates this value (see below).
// Suggestions also need to be provided to the Autosuggest,
// and they are initially empty because the Autosuggest is closed.
_this.onChange=function(event,_ref){var newValue=_ref.newValue;_this.props.onChange(newValue);};_this.onSuggestionsFetchRequested=function(_ref2){var value=_ref2.value;_this.setState({suggestions:_this.getSuggestions(value)});};_this.onSuggestionsClearRequested=function(){_this.setState({suggestions:[]});};_this.getSuggestions=function(value){var inputValue=value.trim().toLowerCase();var inputLength=inputValue.length;return inputLength===0?[]:this.props.suggestions.filter(function(lang){return lang.toLowerCase().slice(0,inputLength)===inputValue;});};_this.getSuggestionValue=function(suggestion){return suggestion;};_this.renderSuggestion=function(suggestion){return AutoSuggestInput_React.createElement("div",null,suggestion);};_this.state={// value: this.props.value? this.props.value: '',
suggestions:[]};return _this;}Object(createClass["a" /* default */])(AutoSuggestInput,[{key:"componentWillMount",value:function componentWillMount(){this.setState({value:this.props.value?this.props.value:''});}},{key:"componentWillReceiveProps",value:function componentWillReceiveProps(nextProps){this.setState({value:nextProps.value?nextProps.value:''});}},{key:"render",value:function render(){var _this$state=this.state,value=_this$state.value,suggestions=_this$state.suggestions;// Autosuggest will pass through all these props to the input.
var inputProps={placeholder:'Ingrese un ingrediente',value:value,onChange:this.onChange};// Finally, render it!
return AutoSuggestInput_React.createElement(dist_default.a,{suggestions:suggestions,onSuggestionsFetchRequested:this.onSuggestionsFetchRequested,onSuggestionsClearRequested:this.onSuggestionsClearRequested,getSuggestionValue:this.getSuggestionValue,renderSuggestion:this.renderSuggestion,inputProps:inputProps});}// Teach Autosuggest how to calculate suggestions for any given input value.
}]);return AutoSuggestInput;}(AutoSuggestInput_React.Component);/* harmony default export */ var components_common_AutoSuggestInput = (AutoSuggestInput_AutoSuggestInput);
// CONCATENATED MODULE: ./src/components/RecipePageComponents/IngredientLine.js
var IngredientLine_React=__webpack_require__(0);var IngredientLine_ButtonToolbar=__webpack_require__(4).ButtonToolbar;var IngredientLine_Table=__webpack_require__(4).Table;var IngredientLine_DropdownButton=__webpack_require__(4).DropdownButton;var IngredientLine_Dropdown=__webpack_require__(4).Dropdown;var IngredientLine_ToggleButton=__webpack_require__(4).ToggleButton;var IngredientLine_Button=__webpack_require__(4).Button;var IngredientLine_Modal=__webpack_require__(4).Modal;var FaMinus=__webpack_require__(41).FaMinusCircle;var IngredientLine_IngredientsLine=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(IngredientsLine,_React$Component);function IngredientsLine(props,context){var _this;Object(classCallCheck["a" /* default */])(this,IngredientsLine);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(IngredientsLine).call(this,props,context));_this.updateSelectedMeasurementUnit=_this.updateSelectedMeasurementUnit.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleIngredientNameChange=_this.handleIngredientNameChange.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleAmountChange=_this.handleAmountChange.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));return _this;}Object(createClass["a" /* default */])(IngredientsLine,[{key:"componentWillMount",value:function componentWillMount(){// this.setState({ingredient: this.props.ingredient});
}},{key:"componentWillReceiveProps",value:function componentWillReceiveProps(nextProps){// this.setState({ingredient: nextProps.ingredient});
}},{key:"render",value:function render(){var _this2=this;return IngredientLine_React.createElement("tr",null,IngredientLine_React.createElement("td",null,IngredientLine_React.createElement(components_common_AutoSuggestInput,{value:this.props.ingredient.ingredientName,onChange:this.handleIngredientNameChange,suggestions:["aaaa","aaab","aaac","aaaad","bbbba"]})),IngredientLine_React.createElement("td",null,IngredientLine_React.createElement("div",{className:"modal-div-form-item-group"},IngredientLine_React.createElement("div",{className:"input-group mb-3"},IngredientLine_React.createElement(IngredientLine_DropdownButton,{size:"sm",variant:"success",title:this.props.ingredient.measurementUnits?this.props.ingredient.measurementUnits:"Select unit"},MeasurementUnits.map(function(option){return IngredientLine_React.createElement(IngredientLine_Dropdown.Item,{onClick:function onClick(){return _this2.updateSelectedMeasurementUnit(option);}},option);}))))),IngredientLine_React.createElement("td",null,IngredientLine_React.createElement("input",{type:"number",step:".01",value:this.props.ingredient.amount,onChange:this.handleAmountChange})),IngredientLine_React.createElement("td",null,IngredientLine_React.createElement(IngredientLine_Button,{variant:"danger",onClick:function onClick(){return _this2.props.removeIngredient(_this2.props.index);}},IngredientLine_React.createElement(FaMinus,null))));}},{key:"updateSelectedMeasurementUnit",value:function updateSelectedMeasurementUnit(option){this.props.handleIngredientUpdate({index:this.props.index,ingredientName:this.props.ingredient.ingredientName,amount:this.props.ingredient.amount,measurementUnits:option});}},{key:"handleIngredientNameChange",value:function handleIngredientNameChange(ingredientName){this.props.handleIngredientUpdate({index:this.props.index,ingredientName:ingredientName,amount:this.props.ingredient.amount,measurementUnits:this.props.ingredient.measurementUnits});}},{key:"handleAmountChange",value:function handleAmountChange(event){this.props.handleIngredientUpdate({index:this.props.index,ingredientName:this.props.ingredient.ingredientName,amount:event.target.value,measurementUnits:this.props.ingredient.measurementUnits});}}]);return IngredientsLine;}(IngredientLine_React.Component);/* harmony default export */ var IngredientLine = (IngredientLine_IngredientsLine);
...
// var Dropdown = require('react-bootstrap').Dropdown;
var FaPlus=__webpack_require__(41).FaPlus;var IngredientsDialog_FaMinus=__webpack_require__(41).FaMinusCircle;var IngredientsDialog_IngredientsDialog=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(IngredientsDialog,_React$Component);function IngredientsDialog(props,context){var _this;Object(classCallCheck["a" /* default */])(this,IngredientsDialog);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(IngredientsDialog).call(this,props,context));_this.lgClose=function(){return _this.setState({lgShow:false});};_this.state={lgShow:false,ingredients:_this.props.ingredients};_this.addIngredient=_this.addIngredient.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleRemoveIngredient=_this.handleRemoveIngredient.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleIngredientUpdate=_this.handleIngredientUpdate.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleSave=_this.handleSave.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleClose=_this.handleClose.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));return _this;}Object(createClass["a" /* default */])(IngredientsDialog,[{key:"componentWillMount",value:function componentWillMount(){// this.setState({ingredients: this.props.ingredients});
}},{key:"componentWillReceiveProps",value:function componentWillReceiveProps(nextProps){this.setState({utensils:nextProps.utensils});}// handleClick() {
// this.lgClose();
...
//     this.setState({searchText: event.target.action});
// }
},{key:"handleClose",value:function handleClose(){// this.props.checkIngredientsAreComplete();
this.lgClose();}},{key:"handleSave",value:function handleSave(){this.props.updateIngredients(this.state.ingredients);this.lgClose();}},{key:"render",value:function render(){var _this2=this;var index=0;return IngredientsDialog_React.createElement(IngredientsDialog_ButtonToolbar,null,IngredientsDialog_React.createElement(IngredientsDialog_Button,{className:"playlist-list-button-div-button",onClick:function onClick(){return _this2.setState({lgShow:true,action:_this2.props.actionInputInitValue,stepTypeSelectedOption:_this2.props.stepTypeSelectedOptionInitValue,importantNotes:_this2.props.importantNotesInputInitValue});}},"Ingredients"),IngredientsDialog_React.createElement(IngredientsDialog_Modal,{size:"lg",show:this.state.lgShow,onHide:this.lgClose},IngredientsDialog_React.createElement("div",{className:"modal-div"},IngredientsDialog_React.createElement("h3",{className:"modal-div-title"},"Ingredients"),IngredientsDialog_React.createElement(IngredientsDialog_Button,{variant:"success",onClick:this.addIngredient},IngredientsDialog_React.createElement(FaPlus,null)),IngredientsDialog_React.createElement("form",{className:"modal-div-form"},IngredientsDialog_React.createElement(IngredientsDialog_Table,null,IngredientsDialog_React.createElement("tbody",null,this.state.ingredients?this.state.ingredients.map(function(ingredient,i){return IngredientsDialog_React.createElement(IngredientLine,_this2.getIngredientProps(i,ingredient));}):undefined)),IngredientsDialog_React.createElement("div",{className:"modal-div-form-item-group button-item-group"},IngredientsDialog_React.createElement(IngredientsDialog_Button,{className:"playlist-add-playlist-cancel-button",onClick:this.handleClose},"Close"),IngredientsDialog_React.createElement(IngredientsDialog_Button,{className:"playlist-add-playlist-create-button",onClick:this.handleSave},this.props.okButtonText?this.props.okButtonText:"Save"))))));}},{key:"getIngredientProps",value:function getIngredientProps(indexOfIngredient,ingredient){return{index:indexOfIngredient,ingredient:ingredient,handleIngredientUpdate:this.handleIngredientUpdate,removeIngredient:this.handleRemoveIngredient};}},{key:"handleIngredientUpdate",value:function handleIngredientUpdate(ingredient){var ingredients=this.state.ingredients;ingredients[ingredient.index]=ingredient;this.setState({ingredients:ingredients});}},{key:"handleRemoveIngredient",value:function handleRemoveIngredient(index){var ingredients=this.state.ingredients;delete ingredients[index];this.setState({ingredients:ingredients});}},{key:"changeSelectedStatus",value:function changeSelectedStatus(utensil){console.log(utensil);utensil.selected=!utensil.selected;this.setState({utensils:this.state.utensils});}},{key:"addIngredient",value:function addIngredient(){var ingredients=this.state.ingredients;ingredients.push({ingredientName:'',measurementUnits:undefined,amount:0});this.setState({ingredients:ingredients});}},{key:"updateStepTypeSelectedOption",value:function updateStepTypeSelectedOption(option){this.setState({stepTypeSelectedOption:option});}}]);return IngredientsDialog;}(IngredientsDialog_React.Component);/* harmony default export */ var RecipePageComponents_IngredientsDialog = (IngredientsDialog_IngredientsDialog);
// CONCATENATED MODULE: ./src/components/RecipePageComponents/StepDialog.js
var StepDialog_React=__webpack_require__(0);var StepDialog_ButtonToolbar=__webpack_require__(4).ButtonToolbar;var StepDialog_Button=__webpack_require__(4).Button;var StepDialog_Modal=__webpack_require__(4).Modal;var StepDialog_DropdownButton=__webpack_require__(4).DropdownButton;var StepDialog_Dropdown=__webpack_require__(4).Dropdown;var StepDialog_StepDialog=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(StepDialog,_React$Component);function StepDialog(props,context){var _this;Object(classCallCheck["a" /* default */])(this,StepDialog);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(StepDialog).call(this,props,context));_this.lgClose=function(){return _this.setState({lgShow:false});};_this.state={lgShow:false,action:_this.props.actionInputInitValue,stepTypeSelectedOption:_this.props.stepTypeSelectedOptionInitValue,importantNotes:_this.props.importantNotesInputInitValue};_this.handleActionChange=_this.handleActionChange.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleImportantNotesChange=_this.handleImportantNotesChange.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.handleClick=_this.handleClick.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));_this.updateIngredients=_this.updateIngredients.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));return _this;}Object(createClass["a" /* default */])(StepDialog,[{key:"handleClick",value:function handleClick(){this.props.action(this.lgClose,this.state.action,this.state.ingredients);}},{key:"handleActionChange",value:function handleActionChange(event){this.setState({action:event.target.value});}},{key:"handleImportantNotesChange",value:function handleImportantNotesChange(event){this.setState({action:event.target.value});}},{key:"render",value:function render(){var _this2=this;return StepDialog_React.createElement(StepDialog_ButtonToolbar,null,StepDialog_React.createElement(StepDialog_Button,{className:"playlist-list-button-div-button",onClick:function onClick(){return _this2.setState({lgShow:true,action:_this2.props.actionInputInitValue,stepTypeSelectedOption:_this2.props.stepTypeSelectedOptionInitValue,importantNotes:_this2.props.importantNotesInputInitValue});}},this.props.buttonText),StepDialog_React.createElement(StepDialog_Modal,{size:"lg",show:this.state.lgShow,onHide:this.lgClose},StepDialog_React.createElement("div",{className:"modal-div"},StepDialog_React.createElement("h3",{className:"modal-div-title"},this.props.dialogTitle),StepDialog_React.createElement("form",{className:"modal-div-form"},StepDialog_React.createElement("div",{className:"modal-div-form-item-group"},StepDialog_React.createElement("div",{className:"input-group mb-3"},StepDialog_React.createElement("div",{className:"input-group-prepend"},StepDialog_React.createElement("span",{className:"input-group-text modal-div-form-item-group-input",id:"basic-addon1"},"Action")),StepDialog_React.createElement("input",{type:"text",className:"form-control","aria-describedby":"basic-addon1",value:this.state.action,onChange:this.handleActionChange}))),StepDialog_React.createElement("div",{className:"modal-div-form-item-group"},StepDialog_React.createElement("div",{className:"input-group mb-3"},StepDialog_React.createElement(RecipePageComponents_IngredientsDialog,this.getIngredientsDialogProps()))),StepDialog_React.createElement("div",{className:"modal-div-form-item-group button-item-group"},StepDialog_React.createElement(StepDialog_Button,{className:"playlist-add-playlist-cancel-button",onClick:this.lgClose},this.props.closeButtonText?this.props.okButtonText:"Close"),StepDialog_React.createElement(StepDialog_Button,{className:"playlist-add-playlist-create-button",onClick:this.handleClick},this.props.okButtonText))))));}},{key:"getUtensilsDialogProps",value:function getUtensilsDialogProps(){return{utensils:this.getUtensils()};}},{key:"getIngredientsDialogProps",value:function getIngredientsDialogProps(){return{ingredients:[],updateIngredients:this.updateIngredients};}},{key:"updateIngredients",value:function updateIngredients(ingredients){// if(ingredients.length > 0){
//     ingredients = ingredients.map(ingredient => {
//         _.remove(ingredient.unitMeasurements = )
//     });
// }
this.setState({ingredients:ingredients});}},{key:"getUtensils",value:function getUtensils(){// var utensilsToReturn = utensils;
// utensilsToReturn[2].selected = true;
// return utensilsToReturn;
return Utensils;}}]);return StepDialog;}(StepDialog_React.Component);/* harmony default export */ var RecipePageComponents_StepDialog = (StepDialog_StepDialog);
...
var AppPages_RecipesPage = __webpack_require__(112);
...
// itemRenameAction: (recipe) => this.renameRecipe(recipe),
};}},{key:"prepareStepList",value:function prepareStepList(){var _this5=this;return{listTitle:"Section's steps",listButton:react_default.a.createElement(RecipePageComponents_StepDialog,this.getAddStepDialog()),// isConfiguredPlaylist: true,
...
itemRightButtons:function itemRightButtons(item){return _this5.getStepItemRightButtons(item);}// itemRemoveAction: (recipe) => this.removeRecipe(recipe),
// itemRenameAction: (recipe) => this.renameRecipe(recipe),
};}},{key:"getStepItemRightButtons",value:function getStepItemRightButtons(item){return react_default.a.createElement("div",null,react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRemoveStepDialog(item)),react_default.a.createElement(RecipePageComponents_StepDialog,this.getEditStepDialog(item)));}},{key:"getEditStepDialog",value:function getEditStepDialog(item){return{buttonText:"Edit Step",//     dialogTitle: "Create Section",
...
action:this.editStep,okButtonText:"Add Step"};}},{key:"editStep",value:function editStep(){}},{key:"getRemoveStepDialog",value:function getRemoveStepDialog(item){return{item:item,buttonText:"Remove Step",dialogTitle:"Are you sure you want to remove "+item.name+" ?",// dialogInputLabel: "Recipe Name",
action:this.removeStep,okButtonText:"Remove step"};}},{key:"removeStep",value:function removeStep(item,name){var _this6=this;this.props.showLoadingModal();fetch('/removestep',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({step:item,section:this.state.selectedSection,recipe:this.state.selectedRecipe}),redirect:'manual'}).then(function(result){var state=_this6;if(result.ok){_this6.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully removed"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"getAddStepDialog",value:function getAddStepDialog(){return{buttonText:"Add Step",//     dialogTitle: "Create Section",
//     dialogButton: <StepDialog {...this.getCopySectionDialog()} />,
//     dialogDropdownLabel: "Select section type",
//     dialogDropdownOptions: sectionsType,
//     dialogInputLabel: "Section Name",
...
var sections=this.state.userRecipes.flatMap(function(recipe){return recipe.sections.map(function(section){return new Object({"recipe":recipe,"section":section,"textToShow":recipe.name+" - "+section.name});});});return sections;}},{key:"getRecipeItemRightButtons",value:function getRecipeItemRightButtons(item){return react_default.a.createElement("div",null,react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRemoveRecipeDialog(item)),react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRenameRecipeDialog(item)));}},{key:"getSectionItemRightButtons",value:function getSectionItemRightButtons(item){return react_default.a.createElement("div",null,react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRemoveSectionDialog(item)),react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getEditSectionDialog(item)));}},{key:"createRecipe",value:function createRecipe(item,name){var _this7=this;this.props.showLoadingModal();fetch('/createrecipe',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({name:name}),redirect:'manual'}).then(function(result){var state=_this7;if(result.ok){_this7.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully created =D"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"addSection",value:function addSection(item,name,type){var _this8=this;if(!name||!type.type){this.props.handleResponse(this.createError("Name and Type are mandatory fields"));}else{this.props.showLoadingModal();fetch('/addsection',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({recipe:this.state.selectedRecipe,section:{name:name,sectionType:type.type}}),redirect:'manual'}).then(function(result){var state=_this8;if(result.ok){_this8.getUserRecipes();state.props.handleResponse({messageToShow:"Section Successfully added =D"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}}},{key:"copySection",value:function copySection(item,name,sectionToCopy){var _this9=this;if(!name||!sectionToCopy){this.props.handleResponse(this.createError("Name and Section to copy are mandatory fields"));}else{this.props.showLoadingModal();fetch('/copysection',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({recipe:this.state.selectedRecipe,name:name,section:{name:sectionToCopy.section.name,recipe:sectionToCopy.recipe.name// sectionType: type
}}),redirect:'manual'}).then(function(result){var state=_this9;if(result.ok){_this9.getUserRecipes();state.props.handleResponse({messageToShow:"Section Successfully copied =D"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}}},{key:"addStep",value:function addStep(closeMethod,action,ingredients){var _this10=this;if(!action){this.props.handleResponse(this.createError("Action is mandatory field"));}else{closeMethod();this.props.showLoadingModal();fetch('/addstep',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({recipe:this.state.selectedRecipe,section:this.state.selectedSection,step:{action:action,ingredients:ingredients}}),redirect:'manual'}).then(function(result){var state=_this10;if(result.ok){_this10.getUserRecipes();state.props.handleResponse({messageToShow:"Section Successfully added =D"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}}},{key:"createError",value:function createError(errorMessage){return{errorToShow:errorMessage};}},{key:"removeRecipe",value:function removeRecipe(item){var _this11=this;this.props.showLoadingModal();fetch('/removerecipe',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({item:item}),redirect:'manual'}).then(function(result){var state=_this11;if(result.ok){_this11.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully removed"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"removeSection",value:function removeSection(item,name){var _this12=this;this.props.showLoadingModal();fetch('/removesection',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({section:item,recipe:this.state.selectedRecipe}),redirect:'manual'}).then(function(result){var state=_this12;if(result.ok){_this12.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully removed"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"editSection",value:function editSection(item,name,selectedType){var _this13=this;if(!name||!selectedType){this.props.handleResponse(this.createError("Name and Type are mandatory fields"));}else{this.props.showLoadingModal();fetch('/updatesection',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({section:item,recipe:this.state.selectedRecipe,newName:name,newSelectedType:selectedType.type}),redirect:'manual'}).then(function(result){var state=_this13;if(result.ok){_this13.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully updated"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}}},{key:"renameRecipe",value:function renameRecipe(item,name){var _this14=this;this.props.showLoadingModal();fetch('/updaterecipe',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({recipe:item,name:name}),redirect:'manual'}).then(function(result){var state=_this14;if(result.ok){_this14.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully updated"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"updateSelectedRecipe",value:function updateSelectedRecipe(recipe){this.setState({selectedRecipe:recipe,selectedSection:''});}},{key:"updateSelectedSection",value:function updateSelectedSection(section){this.setState({selectedSection:section});}//
...
var AppPages_ConfigurePage = __webpack_require__(113);

// EXTERNAL MODULE: ./node_modules/react-bootstrap/Button.js
var react_bootstrap_Button = __webpack_require__(49);
...
var common_LoadingModal = __webpack_require__(117);
