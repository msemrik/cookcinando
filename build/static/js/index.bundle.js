...
var sectionsType=['Masa','Salsa','Relleno','Carnes','Salteados','Horneados'];/* harmony default export */ var SectionsType = (sectionsType);
...
itemActionOnClick:function itemActionOnClick(recipe){return _this4.updateSelectedSection(recipe);},itemRightButtons:function itemRightButtons(item){return _this4.getSectionItemRightButtons(item);}// itemRemoveAction: (recipe) => this.removeRecipe(recipe),
// itemRenameAction: (recipe) => this.renameRecipe(recipe),
};}},{key:"getAddSectionDialog",value:function getAddSectionDialog(){return{buttonText:"Add Section",dialogTitle:"Create Section",dialogDropdownLabel:"Select section type",dialogDropdownOptions:SectionsType,dialogInputLabel:"Section Name",action:this.addSection,okButtonText:"Add Section"};}},{key:"getRecipeItemRightButtons",value:function getRecipeItemRightButtons(item){return react_default.a.createElement("div",null,react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRemoveRecipeDialog(item)),react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRenameRecipeDialog(item)));}},{key:"getSectionItemRightButtons",value:function getSectionItemRightButtons(item){return react_default.a.createElement("div",null,react_default.a.createElement(components_RecipePageComponents_NewDialog,this.getRemoveSectionDialog(item)));}},{key:"getRemoveRecipeDialog",value:function getRemoveRecipeDialog(item){var _this5=this;return{item:item,buttonText:"Remove Recipe",dialogTitle:"Are you sure you want to remove "+item.name+" ?",// dialogInputLabel: "Recipe Name",
action:function action(name,item){return _this5.removeRecipe(name,item);},okButtonText:"Remove Recipe"};}},{key:"getRenameRecipeDialog",value:function getRenameRecipeDialog(item){var _this6=this;return{item:item,buttonText:"Rename Recipe",dialogTitle:"Rename Recipe "+item.name,dialogInputLabel:"Recipe Name",action:function action(name,item){return _this6.renameRecipe(name,item);},okButtonText:"Rename Recipe"};}},{key:"getRemoveSectionDialog",value:function getRemoveSectionDialog(item){var _this7=this;return{item:item,buttonText:"Remove Section",dialogTitle:"Are you sure you want to remove "+item.name+" ?",// dialogInputLabel: "Recipe Name",
action:function action(name,item){return _this7.removeSection(name,item);},okButtonText:"Remove section"};}//TODO ADD UPDATE SECTION (show dialog)
},{key:"getRenameSectionDialog",value:function getRenameSectionDialog(item){return{// item: item,
...
};}},{key:"createRecipe",value:function createRecipe(name){var _this8=this;this.props.showLoadingModal();fetch('/createrecipe',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({name:name}),redirect:'manual'}).then(function(result){var state=_this8;if(result.ok){_this8.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully created =D"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"addSection",value:function addSection(name,type){var _this9=this;if(!name||!type){this.props.handleResponse(this.createError("Name and Type are mandatory fields"));}else{this.props.showLoadingModal();fetch('/addsection',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({recipe:this.state.selectedRecipe,section:{name:name,type:type}}),redirect:'manual'}).then(function(result){var state=_this9;if(result.ok){_this9.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully created =D"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}}},{key:"createError",value:function createError(errorMessage){return{errorToShow:errorMessage};}},{key:"removeRecipe",value:function removeRecipe(name,item){var _this10=this;this.props.showLoadingModal();fetch('/removerecipe',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({item:item}),redirect:'manual'}).then(function(result){var state=_this10;if(result.ok){_this10.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully removed"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"removeSection",value:function removeSection(name,item){var _this11=this;this.props.showLoadingModal();fetch('/removesection',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({section:item,recipe:this.state.selectedRecipe}),redirect:'manual'}).then(function(result){var state=_this11;if(result.ok){_this11.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully removed"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"renameRecipe",value:function renameRecipe(name,item){var _this12=this;this.props.showLoadingModal();fetch('/updaterecipe',{method:'POST',headers:{'Content-Type':"application/json"},body:JSON.stringify({item:item,name:name}),redirect:'manual'}).then(function(result){var state=_this12;if(result.ok){_this12.getUserRecipes();state.props.handleResponse({messageToShow:"Recipe Successfully updated"});}else{result.json().then(function(error){state.props.handleResponse(error);state.props.hideLoadingModal();});}});}},{key:"updateSelectedRecipe",value:function updateSelectedRecipe(recipe){this.setState({selectedRecipe:recipe// spotifyPlaylistsToBeShown: this.state.userPlaylists.spotifyPlaylists.map((spotifyPlaylist) => {
//     spotifyPlaylist.selected = _.find(playlist.includedPlaylists, {"playlistId": spotifyPlaylist.id}) ? true : false;
//     return spotifyPlaylist;
// })
});}},{key:"updateSelectedSection",value:function updateSelectedSection(section){this.setState({selectedSection:section// spotifyPlaylistsToBeShown: this.state.userPlaylists.spotifyPlaylists.map((spotifyPlaylist) => {
//     spotifyPlaylist.selected = _.find(playlist.includedPlaylists, {"playlistId": spotifyPlaylist.id}) ? true : false;
//     return spotifyPlaylist;
// })
});}//
