...
var IngredientLine_React=__webpack_require__(0);var IngredientLine_ButtonToolbar=__webpack_require__(4).ButtonToolbar;var IngredientLine_Table=__webpack_require__(4).Table;var IngredientLine_ToggleButton=__webpack_require__(4).ToggleButton;var IngredientLine_Button=__webpack_require__(4).Button;var IngredientLine_Modal=__webpack_require__(4).Modal;// var DropdownButton = require('react-bootstrap').DropdownButton;
// var Dropdown = require('react-bootstrap').Dropdown;
var IngredientLine_UtensilsDialog=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(UtensilsDialog,_React$Component);function UtensilsDialog(props,context){var _this;Object(classCallCheck["a" /* default */])(this,UtensilsDialog);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(UtensilsDialog).call(this,props,context));_this.lgClose=function(){return _this.setState({lgShow:false});};_this.state={lgShow:false,action:_this.props.actionInputInitValue,stepTypeSelectedOption:_this.props.stepTypeSelectedOptionInitValue,importantNotes:_this.props.importantNotesInputInitValue};_this.handleSearchTextChange=_this.handleSearchTextChange.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));// this.handleClick = this.handleClick.bind(this);
return _this;}Object(createClass["a" /* default */])(UtensilsDialog,[{key:"componentWillMount",value:function componentWillMount(){this.setState({utensils:this.props.utensils});}},{key:"componentWillReceiveProps",value:function componentWillReceiveProps(nextProps){this.setState({utensils:nextProps.utensils});}},{key:"handleClick",value:function handleClick(){this.lgClose();this.props.action(this.props.item,this.state.name,this.state.dropdownSelectedOption);}},{key:"handleSearchTextChange",value:function handleSearchTextChange(event){this.setState({searchText:event.target.value});}// handleImportantNotesChange(event) {
//     this.setState({searchText: event.target.action});
// }
},{key:"render",value:function render(){return IngredientLine_React.createElement("tr",null,IngredientLine_React.createElement("td",null,IngredientLine_React.createElement("input",null)),IngredientLine_React.createElement("td",null,this.props.ingredient),IngredientLine_React.createElement("td",null,"AAAA"));}},{key:"changeSelectedStatus",value:function changeSelectedStatus(utensil){console.log(utensil);utensil.selected=!utensil.selected;this.setState({utensils:this.state.utensils});}},{key:"updateStepTypeSelectedOption",value:function updateStepTypeSelectedOption(option){this.setState({stepTypeSelectedOption:option});}}]);return UtensilsDialog;}(IngredientLine_React.Component);/* harmony default export */ var IngredientLine = (IngredientLine_UtensilsDialog);
...
// var Dropdown = require('react-bootstrap').Dropdown;
var FaPlus=__webpack_require__(104).FaPlus;var IngredientsDialog_IngredientsDialog=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(IngredientsDialog,_React$Component);function IngredientsDialog(props,context){var _this;Object(classCallCheck["a" /* default */])(this,IngredientsDialog);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(IngredientsDialog).call(this,props,context));_this.lgClose=function(){return _this.setState({lgShow:false});};_this.state={lgShow:false,ingredients:[]};_this.addIngredient=_this.addIngredient.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));// this.handleClick = this.handleClick.bind(this);
return _this;}Object(createClass["a" /* default */])(IngredientsDialog,[{key:"componentWillMount",value:function componentWillMount(){// this.setState({ingredients: this.props.ingredients});
}},{key:"componentWillReceiveProps",value:function componentWillReceiveProps(nextProps){this.setState({utensils:nextProps.utensils});}},{key:"handleClick",value:function handleClick(){this.lgClose();this.props.action(this.props.item,this.state.name,this.state.dropdownSelectedOption);}// handleSearchTextChange(event) {
//     this.setState({searchText: event.target.value});
// }
// handleImportantNotesChange(event) {
//     this.setState({searchText: event.target.action});
// }
},{key:"render",value:function render(){var _this2=this;return IngredientsDialog_React.createElement(IngredientsDialog_ButtonToolbar,null,IngredientsDialog_React.createElement(IngredientsDialog_Button,{className:"playlist-list-button-div-button",onClick:function onClick(){return _this2.setState({lgShow:true,action:_this2.props.actionInputInitValue,stepTypeSelectedOption:_this2.props.stepTypeSelectedOptionInitValue,importantNotes:_this2.props.importantNotesInputInitValue});}},"Ingredients"),IngredientsDialog_React.createElement(IngredientsDialog_Modal,{size:"lg",show:this.state.lgShow,onHide:this.lgClose},IngredientsDialog_React.createElement("div",{className:"modal-div"},IngredientsDialog_React.createElement("h3",{className:"modal-div-title"},"Ingredients"),IngredientsDialog_React.createElement(IngredientsDialog_Button,{variant:"success",onClick:this.addIngredient},IngredientsDialog_React.createElement(FaPlus,null)),IngredientsDialog_React.createElement("form",{className:"modal-div-form"},IngredientsDialog_React.createElement(IngredientsDialog_Table,null,IngredientsDialog_React.createElement("tbody",null,this.state.ingredients?this.state.ingredients.map(function(ingredient){return IngredientsDialog_React.createElement(IngredientLine,{ingredient2:ingredient});}):undefined)),IngredientsDialog_React.createElement("div",{className:"modal-div-form-item-group button-item-group"},IngredientsDialog_React.createElement(IngredientsDialog_Button,{className:"playlist-add-playlist-cancel-button",onClick:this.lgClose},this.props.closeButtonText?this.props.okButtonText:"Close"),IngredientsDialog_React.createElement(IngredientsDialog_Button,{className:"playlist-add-playlist-create-button",onClick:this.handleClick},this.props.okButtonText))))));}},{key:"changeSelectedStatus",value:function changeSelectedStatus(utensil){console.log(utensil);utensil.selected=!utensil.selected;this.setState({utensils:this.state.utensils});}},{key:"addIngredient",value:function addIngredient(){var ingredients=this.state.ingredients;ingredients.push({});this.setState({ingredients:ingredients});// this.state.push()
}},{key:"updateStepTypeSelectedOption",value:function updateStepTypeSelectedOption(option){this.setState({stepTypeSelectedOption:option});}}]);return IngredientsDialog;}(IngredientsDialog_React.Component);/* harmony default export */ var RecipePageComponents_IngredientsDialog = (IngredientsDialog_IngredientsDialog);
